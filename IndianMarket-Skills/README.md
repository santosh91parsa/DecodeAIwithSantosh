# IndianMarket-Skills — Claude Code Skills for INDmoney Portfolio Analysis
...
mkdir -p ~/.claude/commands
cp DecodeAIwithSantosh/IndianMarket-Skills/.claude/commands/quick-trade.md ~/.claude/commands/
cp DecodeAIwithSantosh/IndianMarket-Skills/.claude/commands/portfolio-alert.md ~/.claude/commands/
```
